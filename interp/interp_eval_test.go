...
func TestEvalArithmetic(t *testing.T) {
	...
	runTests(t, i, []testCase{
		...
		{desc: "add_SI", src: `"foo" + 1`, err: "1:28: invalid operation: mismatched types string and untyped int"},
		...
		{desc: "bitnot_F", src: "^0.2", err: "1:28: invalid operation: ^ untyped float"},
		{desc: "not_B", src: "!false", res: "true"},
		{desc: "not_I", src: "!0", err: "1:28: invalid operation: ! untyped int"},
	})
}
...
func TestEvalAssign(t *testing.T) {
	...
	runTests(t, i, []testCase{
		...
		{src: "e := 64.4; e %= 64", err: "1:39: invalid operation: operator %= not defined on untyped float"},
